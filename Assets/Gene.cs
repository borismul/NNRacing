...
public class Gene {
    ...
    public static int maximumAllowedLayers = 10;
    ...
    public static NeuralNetwork MakeChild(Gene dad, Gene mom, float mutationChance)
    {
        string networkGene = "";
        ...
        for (int i = 0; i < dad.weightsGene.Count; i++)
        {
            ...
            if((float)NeuralNetwork.rand.NextDouble() < mutationChance)
            {
                newWeight = (float)NeuralNetwork.rand.NextDouble();
            }
